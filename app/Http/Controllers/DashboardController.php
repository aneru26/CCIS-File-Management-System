        ...
        if(Auth::user()->user_type == 1)
            {
                ...
                $data['TotalDocument'] = HomeworkModel::getRecordCount();
            ...
            {
                $data['TotalCourseCode'] = classModel::getTotalRecordFaculty();
                $data['TotalDocuments'] = HomeworkModel::facultygetRecordCount();
